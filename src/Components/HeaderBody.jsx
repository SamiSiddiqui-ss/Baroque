...
function Header() {
  ...
  <Row className='flex'>
    <Col xs={12} sm={12} md={4}lg={4}  className=' flex flex-col items-center'>
      <img className='pt-5 pb-3' width={400} src="/public/images/img1.webp" alt="Shawls 1" />
    ...
    <Col xs={12} sm={12} md={4} lg={4}  className='flex flex-col items-center'>
      <img className='pt-5 pb-3' width={400} src="/public/images/img2.webp" alt="Shawls 2" />
      <h1 className='sami p-2 text-3xl md:text-xl lg:text-3xl'>READY TO WEAR</h1>
      <Link to="/Page2"><button className='btns buttonn pt-2 pb-2'>SHOP NOW</button></Link>
    </Col>
    <Col xs={12} sm={12} md={4} lg={4} className='flex flex-col items-center'>
      <img className='pt-5 pb-3' width={400} src="/public/images/img3.webp" alt="Shawls 3" />
